...
const PEST_CONTROL_DATA: PestControlItem[] = [
  ...
  },
  {
    ...
    type: 'pest',
    symptoms: 'Мелкие желтые точки на листьях, тонкая паутинка. Листья желтеют и сохнут.',
    treatment: 'Опрыскивание Фитовермом или Битоксибациллином. В тяжелых случаях — Актеллик.',
    prevention: 'Частое опрыскивание водой (клещ боится влаги), удаление сорняков.',
  },
  {
    id: 'colorado_beetle',
    title: 'Колорадский жук',
    type: 'pest',
    symptoms: 'Полосатые жуки и красные личинки объедают листья картофеля и баклажанов.',
    treatment: 'Ручной сбор. Био: Битоксибациллин, Фитоверм. Химия: Корадо, Актара.',
    prevention: 'Высокое окучивание, посадка календулы и бархатцев в междурядьях.',
  },
  {
    id: 'whitefly',
    title: 'Белокрылка',
    type: 'pest',
    symptoms: 'Мелкие белые мошки взлетают при касании. Листья желтеют, появляется сажистый грибок.',
    treatment: 'Желтые клеевые ловушки. Фитоверм (3 обработки через 5 дней), Теппеки.',
    prevention: 'Проветривание теплиц, промораживание теплицы зимой.',
  },
  {
    id: 'mole_cricket',
    title: 'Медведка',
    type: 'pest',
    symptoms: 'Подгрызенные корни, увядшая рассада, ходы в земле.',
    treatment: 'Ловушки с навозом осенью. Препараты: Гром, Медветокс. Заливка ходов мыльной водой.',
    prevention: 'Глубокая перекопка почвы осенью, ограждение грядок сеткой.',
  },
  {
    id: 'black_leg',
    title: 'Черная ножка',
    type: 'disease',
    symptoms: 'Стебель рассады чернеет и утончается у земли, растение падает.',
    treatment: 'Удалить больные растения. Полить Фитоспорином или Превикуром.',
    prevention: 'Не заливать рассаду, прокаливать грунт перед посевом, посыпать землю золой.',
  },
  {
    id: 'blossom_end_rot',
    title: 'Вершинная гниль',
    type: 'disease',
    symptoms: 'Водянистые, затем черные пятна на верхушке плодов томатов и перцев.',
    treatment: 'Это не инфекция, а нехватка кальция! Опрыскать Кальциевой селитрой (10г на 10л).',
    prevention: 'Регулярный полив (без скачков), подкормка кальцием при завязывании плодов.',
  },
  {
    id: 'cladosporium',
    title: 'Кладоспориоз',
    type: 'disease',
    symptoms: 'Бурые пятна на листьях томатов, снизу листа — оливковый налет.',
    treatment: 'Проветривание! Обработка Фитоспорином-М, препаратами меди (Хом, Абига-Пик).',
    prevention: 'Снижение влажности в теплице, мульчирование почвы.',
  },
  {
    id: 'moniliosis',
    title: 'Монилиоз',
    type: 'disease',
    symptoms: 'Ветки косточковых сохнут как обожженные, плоды гниют с серыми точками.',
    treatment: 'Обрезка пораженных веток с захватом здоровой части. Хорус (весной), Скор.',
    prevention: 'Обработка медьсодержащими препаратами ранней весной и осенью.',
  },
];
